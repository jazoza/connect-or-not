...
LPD8806 strip = LPD8806(512, dataPin, clockPin);
...
void loop() {
  ...
  colorWipe(strip.Color(0,90,127), 20);      // turquoise
   dither(strip.Color(127,40,0),50);            // red, slow

  for (int i=0; i < 10; i++) {
    dither(strip.Color(random(20, 255),random(20, 255),random(20, 255)),50);
  } 
 ...
 // scanner(127,0,0, 30);        // red, slow
  ...
  // Wavy ripple effects
  wave(strip.Color(127,90,0), 4, 20);        // candy cane
